        ...
        switch (listType) {
            case "Toxic Plants":
                plantList.add(new PlantModel.Plant(
                        ...
                        "Lifespan: This plant typically has a lifespan of a few months to a few years, depending on its growing conditions and care. However, its toxicity remains consistent throughout its lifespan.\n",
